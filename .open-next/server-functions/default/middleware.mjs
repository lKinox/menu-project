...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      class E {
        ...
        waitUntil(e10) {
          if ("external" === this[x].kind)
            return (0, this[x].function)(e10);
      ...
      class j {
        ...
        analyze() {
          ...
          this[A].domainLocale = this[A].options.i18nProvider ? this[A].options.i18nProvider.detectDomainLocale(o2) : function(e11, t3, r3) {
            if (e11)
              for (let a3 of (r3 && (r3 = r3.toLowerCase()), e11)) {
                var n3, i3;
                if (t3 === (null == (n3 = a3.domain) ? void 0 : n3.split(":", 1)[0].toLowerCase()) || r3 === a3.defaultLocale.toLowerCase() || (null == (i3 = a3.locales) ? void 0 : i3.some((e12) => e12.toLowerCase() === r3)))
                  return a3;
              }
        ...
        set locale(e10) {
          var t2, r2;
          if (!this[A].locale || !(null == (r2 = this[A].options.nextConfig) || null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e10)))
      ...
      function eU(e10, t2) {
        if ("x-middleware-set-cookie" in e10.headers && "string" == typeof e10.headers["x-middleware-set-cookie"]) {
          ...
          for (let e11 of new L.ResponseCookies(n2).getAll())
            t2.set(e11);
        }
      }
      ...
      async function ti(e10) {
        ...
        for (let e11 of [...o2.searchParams.keys()]) {
          let t3 = o2.searchParams.getAll(e11), r2 = function(e12) {
            for (let t4 of ["nxtP", "nxtI"])
              if (e12 !== t4 && e12.startsWith(t4))
                return e12.substring(t4.length);
            return null;
          }(e11);
          if (r2) {
        ...
        if (_2) {
          for (let [e11, t3] of p2)
            m2.headers.set(`x-middleware-request-${e11}`, t3), w2.push(e11);
          ...
          class s extends e2 {
            constructor(e3) {
              ...
              if (super(), this._intervalCount = 0, this._intervalEnd = 0, this._pendingCount = 0, this._resolveEmpty = a, this._resolveIdle = a, !("number" == typeof (e3 = Object.assign({ carryoverConcurrencyCount: false, intervalCap: 1 / 0, interval: 0, concurrency: 1 / 0, autoStart: true, queueClass: r2.default }, e3)).intervalCap && e3.intervalCap >= 1))
                throw TypeError(`Expected \`intervalCap\` to be a number from 1 and up, got \`${null != (n2 = null == (t3 = e3.intervalCap) ? void 0 : t3.toString()) ? n2 : ""}\` (${typeof e3.intervalCap})`);
              if (void 0 === e3.interval || !(Number.isFinite(e3.interval) && e3.interval >= 0))
                throw TypeError(`Expected \`interval\` to be a finite number >= 0, got \`${null != (o2 = null == (i2 = e3.interval) ? void 0 : i2.toString()) ? o2 : ""}\` (${typeof e3.interval})`);
        ...
        var t2 = { 491: (e2, t3, r2) => {
          ...
          t3.registerGlobal = function(e3, t4, r3, n3 = false) {
            ...
            if (n3 && (0, a2.isCompatible)(n3))
              return null == (r3 = l[s]) ? void 0 : r3[e3];
          ...
          function a2(e3) {
            ...
            return function(e4) {
              ...
              if (null != s.prerelease || a3.major !== s.major)
                return o(e4);
              if (0 === a3.major)
                return a3.minor === s.minor && a3.patch <= s.patch ? (t4.add(e4), true) : o(e4);
